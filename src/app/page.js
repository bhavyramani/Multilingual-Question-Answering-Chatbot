        ...
        <div className="w-full px-5 sm:w-5/6 flex justify-center mt-4">
          <div className="flex w-full max-w-4xl gap-2 items-center">
            ...
            <svg
              onClick={sendMessage}
              viewBox="0 0 24 24"
              className={`h-11 p-1 bg-gradient-to-br ${sent === false && message !== "" ? "from-blue-600 cursor-pointer to-purple-500 hover:bg-gradient-to-bl focus:ring focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800" : "from-blue-800 to-purple-800"} rounded-xl`}
              fill="none"
